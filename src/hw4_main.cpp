...
int main(){
	...
	cout<<endl;
	string s;
	cout<<"Enter text(only using a,b,c,d,e && length 5)ex:abcba : ";
	cin>>s;
	...
	cout<<"\n\n--------------兩種方式的編碼各自的編碼時間----------------:\n";
	cout << endl << "進行運算所花費的時間(huffman)：" << time0 / CLOCKS_PER_SEC << " S" << endl;
	cout << endl << "進行運算所花費的時間(arithmetic coding)：" << time1 / CLOCKS_PER_SEC << " S" << endl <<endl;
